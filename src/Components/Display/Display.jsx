...
function Display({ theme, getTheme }) {
    ...
    const openSocket = (user) => {
        ...
        let socket = new WebSocket(`ws://192.168.0.140:9090/chat?userCode=${user.userCode}&textChatNo=0`);
        ...
        <>
            ...
            <NotLogin>
                ...
                <HeaderArea style={{backgroundColor : 'transparent', margin:0}}>
                    <Header data={getUser} theme={theme}/>
                </HeaderArea>
            ...
            <Container>
                {/* <ModalAlarm/> */}
                <HeaderArea>
                    <Header data={getUser} theme={theme} getTheme={getTheme}/>
                </HeaderArea>
                <BodyArea>
                    <SideBarDiv>
                        <Sidebar theme={theme}
